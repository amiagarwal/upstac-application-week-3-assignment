...
public class LabRequestController {
    ...
    /** Returns all the test requests with initiated status for the lab testing. */
    ...
    /** Returns all the test requests assigned to current logged in tester. */
    @GetMapping
    @PreAuthorize("hasAnyRole('TESTER')")
    ...
    /** Assigns the test request to the current logged in tester. */
    @PreAuthorize("hasAnyRole('TESTER')")
    ...
    /** Updates the lab test result for the given test request ID. */
    @PreAuthorize("hasAnyRole('TESTER')")
